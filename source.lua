...
local Utility = {}
local Objects = {}
function Zyph:DraggingEnabled(frame, parent)
...
function Zyph.CreateLib(kavName, themeList)
    ...
    Zyph:DraggingEnabled(MainHeader, Main)
    ...
    function Zyph:ChangeColor(prope,color)
